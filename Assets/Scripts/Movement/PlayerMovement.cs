...
namespace Movement
{
    public class PlayerMovement : MonoBehaviour
        ...
        {
            float velocityMultiplication = movementVelocity*Time.fixedDeltaTime;
            float verticalVelocity = _inputManager.JumpButtonPressed && !_collisionsHandler.IsOnAir ? jumpVelocity : _rigidbody2D.velocity.y;
